...
%>
    ...
    <div class="main-content">
        ...
        <form action="PostPost" class="form-register" method="post" >
            ...
            <div class="form-register-with-email">
                ...
                <div class="form-white-background">
					...
					<div id="id" class="form-row" >
                        <label>
                            <span>ID</span>
                            <input type="text" name="_id" id="_id" placeholder="enter the ID of the post to post">
                        </label>
                    </div>
